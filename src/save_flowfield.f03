...
contains
    ...
    subroutine initialize_h5_file(filename)
        ...
        if (mpiRank == mpiMaster) then
            ...
            call h5save_CPartial_Init( filename,  'u', (/ mx/2, mz, my /), sp )
            call h5save_CPartial_Init( filename,  'v', (/ mx/2, mz, my /), sp )
            call h5save_CPartial_Init( filename,  'w', (/ mx/2, mz, my /), sp )
            ! Initialize variables in the h5 for the vorticities for partial saving
            call h5save_CPartial_Init( filename, 'o1', (/ mx/2, mz, my /), sp )
            call h5save_CPartial_Init( filename, 'o2', (/ mx/2, mz, my /), sp )
            call h5save_CPartial_Init( filename, 'o3', (/ mx/2, mz, my /), sp )
        endif
